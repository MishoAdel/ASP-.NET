...
namespace StockMarketSolution.ViewComponents
{
    public class SelectedStockViewComponent : ViewComponent
    {
        ...
        private readonly IStockSrevice _stocksService;
        ...
        public SelectedStockViewComponent(IOptions<TradingOptions> tradingOptions, IStockSrevice stocksService, IFinnhubService finnhubService, IConfiguration configuration)
        {
