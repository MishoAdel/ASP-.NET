...
namespace OrdersEntities.Migrations
{
    ...
    [Migration("20251030120933_Init-database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrdersEntities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderDate = new DateTime(2025, 10, 30, 15, 9, 28, 300, DateTimeKind.Local).AddTicks(3226),
                            OrderNumber = "ORD001",
                            TotalAmount = 66.5m
                        },
                        new
                        {
                            ...
                            OrderDate = new DateTime(2025, 10, 30, 15, 9, 28, 306, DateTimeKind.Local).AddTicks(2957),
                            OrderNumber = "ORD002",
                            TotalAmount = 225.8m
                        });
                });

            modelBuilder.Entity("OrdersEntities.OrderItem", b =>
                {
